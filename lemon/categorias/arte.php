    ...
    <header class="container-fluid py-3" style="background-color: #289256;">
        <div class="row align-items-center">
            ...
            <div class="col-6 text-center">
                <h1 style="color: white; text-transform: uppercase;" class="m-0">Arte e Design</h1>
            </div>
                ...
                <div id="postsContainer">
                    <div class="post">
                        <div class="d-flex align-items-center mb-3">
                            ...
                            <h5 class="ms-2">juju</h5>
                        </div>
                        <p>fui no evento do van gogh com namorado, recomendoo!</p>
                        <img class="rounded-4" src="https://i.pinimg.com/1200x/69/64/50/696450f39d5a049179b9e5f6ea117e8f.jpg" width="300px" alt="post01">
                    </div>
                    ...
                    <div class="post">
                        ...
                        <img class="rounded-4" src="https://i.pinimg.com/736x/bb/23/bc/bb23bc0450c6a029af4c153f3e528c2b.jpg" width="300px" alt="post01">
                    </div>
