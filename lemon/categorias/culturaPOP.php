    ...
    <header class="container-fluid py-3" style="background-color: #289256;">
        <div class="row align-items-center">
            ...
            <div class="col-6 text-center">
                <h1 style="color: white; text-transform: uppercase;" class="m-0">Cultura POP</h1>
            </div>
                ...
                <div id="postsContainer">
                    ...
                    <div class="post">
                        <div class="d-flex align-items-center mb-3">
                            ...
                            <h5 class="ms-2"> once once </h5>
                        </div>
                        <p> pra mim a beyonce é tipo a industria musical inteira como pode alguém divar TANTO te amo mamy</p>
                    </div>
                    ...
                    <div class="post">
                        <div class="d-flex align-items-center mb-3">
                            ...
                            <h5 class="ms-2">swiftie </h5>
                        </div>
                        <p> essa foto definitivamente devia ir para os livros de história </p>
                        <img class="rounded-4" src="https://i.pinimg.com/1200x/c2/53/10/c253104c0b6c103582a3770ebe09e931.jpg" width="300px" alt="post01">
                    </div>
                    ...
                    <div class="post">
                        <div class="d-flex align-items-center mb-3">
                            ...
                            <h5 class="ms-2"> ney </h5>
                        </div>
                        <p>Sinceramente, às vezes eu me sinto amiga íntima dos Beatles, mas não faço a menor ideia do motivo. Do nada também viro melhor amiga da Lady Gaga, principalmente quando ela tá ali — casualmente — cantando num bar com o Bruno Mars, enquanto eu divido uma cerveja com o Homer Simpson como se isso fosse a coisa mais normal do mundo. </p>
                        <img class="rounded-4" src="https://i.pinimg.com/736x/9a/cf/29/9acf29d1f1ca63147916bb43c0096692.jpg" width="300px" alt="post01">
                    </div>
