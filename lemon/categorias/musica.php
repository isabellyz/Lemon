    ...
    <header class="container-fluid py-3" style="background-color: #289256;">
        <div class="row align-items-center">
            ...
            <div class="col-6 text-center">
                <h1 style="color: white; text-transform: uppercase;" class="m-0">Música</h1>
            </div>
                ...
                <div id="postsContainer">
                    <div class="post">
                        <div class="d-flex align-items-center mb-3">
                            ...
                            <h5 class="ms-2">RockeiroRaiz</h5>
                        </div>
                        <p>Ozzy Osborne Dentro dos nossos corações!!</p>
                    </div>
                    ...
                    <div class="post">
                        ...
                        <p>queria ir no show do bk</p>
                        <img class="rounded-4" src="https://i.pinimg.com/1200x/84/3e/ed/843eed9978fab45c247bd60baad009ca.jpg" width="300px" alt="post01">
                    </div>
