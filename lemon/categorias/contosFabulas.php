    ...
    <header class="container-fluid py-3" style="background-color: #289256;">
        <div class="row align-items-center">
            ...
            <div class="col-6 text-center">
                <h1 style="color: white; text-transform: uppercase;" class="m-0">Contos e Fabulas</h1>
            </div>
                ...
                <div id="postsContainer">
                    <div class="post">
                        <div class="d-flex align-items-center mb-3">
                            ...
                            <h5 class="ms-2"> jussy </h5>
                        </div>
                        <p> olhem meu desenho de chapeuzinho vermelho</p>
                        <img class="rounded-4" src="https://i.pinimg.com/736x/09/04/c7/0904c7a2b42308ec41b24303f0ec8051.jpg" width="300px" alt="post01">
                    </div>
                    ...
                    <div class="post">
                        <div class="d-flex align-items-center mb-3">
                            ...
                            <h5 class="ms-2"> neo </h5>
                        </div>
                        <p>fatos: a melhor fabula já escrita</p>
                        <img class="rounded-4" src="https://i.pinimg.com/736x/42/c8/e5/42c8e57b0d545f64e71462050e3d466d.jpg" width="300px" alt="post01">
                    </div>
