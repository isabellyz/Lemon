    ...
    <header class="container-fluid py-3" style="background-color: #289256;">
        <div class="row align-items-center">
            ...
            <div class="col-6 text-center">
                <h1 style="color: white; text-transform: uppercase;" class="m-0">Livro e Literatura</h1>
            </div>
            ...
            <div class="col-12 col-md-6">
                ...
                <div id="postsContainer">
                    <div class="post">
                        ...
                        <p>Quem nunca leu diario de um Banana?</p>
                        <img class="rounded-4" src="https://i.pinimg.com/736x/f2/06/68/f206684cda240ad3c314a864c1d7d201.jpg" width="300px" alt="post01">
                    </div>
                    ...
                    <div class="post">
                        ...
                        <p>Diviei lendo Romeu e Julieta!!</p>
                    </div>
                    ...
                    <div class="post">
                        ...
                        <p>Hoje em dia, ninguem mais gosta de ler, todo mundo está com cerebro tiktokizado, cansei de gente intelectual #lacrei</p>
                        <img class="rounded-4" src="https://i.pinimg.com/1200x/4f/2a/bd/4f2abdb05f013119c609bed2a7d97f73.jpg" width="300px" alt="post01">
                    </div>
