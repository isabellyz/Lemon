    ...
    <header class="container-fluid py-3" style="background-color: #289256;">
        <div class="row align-items-center">
            ...
            <div class="col-6 text-center">
                <h1 style="color: white; text-transform: uppercase;" class="m-0">Curiosidades</h1>
            </div>
                ...
                <div id="postsContainer">
                    <div class="post">
                        <div class="d-flex align-items-center mb-3">
                            ...
                            <h5 class="ms-2">Voce Sabia</h5>
                        </div>
                        <img class="rounded-4" src="https://i.pinimg.com/736x/68/b6/05/68b605ecd9c236cf600f1fc2159efcd2.jpg" width="300px" alt="post01">
                    </div>
                    ...
                    <div class="post">
                        ...
                        <p>A Austrália é mais larga que a Lua. A Lua tem cerca de $3.474$ km de diâmetro, enquanto a Austrália tem cerca de $4.000$ km de largura de leste a oeste.</p>
                    </div>
                    ...
                    <div class="post">
                        <div class="d-flex align-items-center mb-3">
                            ...
                            <h5 class="ms-2">Jurandir</h5>
                        </div>
                        <p>KKKKKKKKKKKKKKKKKK olha isso</p>
                        <img class="rounded-4" src="https://i.pinimg.com/736x/53/e8/bb/53e8bbc4faa29147be3cb9afa11a5219.jpg" width="300px" alt="post01">
                    </div>
