    ...
    <header class="container-fluid py-3" style="background-color: #289256;">
        <div class="row align-items-center">
            ...
            <div class="col-6 text-center">
                <h1 style="color: white; text-transform: uppercase;" class="m-0">Moda e Estilo</h1>
            </div>
                ...
                <div id="postsContainer">
                    <div class="post">
                        <div class="d-flex align-items-center mb-3">
                            ...
                            <h5 class="ms-2">fan_clube_dua_lipa</h5>
                        </div>
                        <p>olhe esse vestido da diva</p>
                        <img class="rounded-4" src="https://i.pinimg.com/736x/86/e5/31/86e5311821b0ee324d48ebaf99253e9e.jpg" width="300px" alt="post01">
                    </div>
                    ...
                    <div class="post">
                        <div class="d-flex align-items-center mb-3">
                            ...
                            <h5 class="ms-2">brunooo</h5>
                        </div>
                        <p>ansiedade de ver o fashion week sp juroooo</p>
                    </div>
                    ...
                    <div class="post">
                        ...
                        <p>meu sonho é ter esse vestido lindoooooo veyr</p>
                        <img class="rounded-4" src="https://i.pinimg.com/736x/59/a6/f1/59a6f19ea13326fc8e4ec8890b0443ab.jpg" width="300px" alt="post01">
                    </div>
