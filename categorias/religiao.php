    ...
    <header class="container-fluid py-3" style="background-color: #289256;">
        <div class="row align-items-center">
            ...
            <div class="col-6 text-center">
                <h1 style="color: white; text-transform: uppercase;" class="m-0">Religião</h1>
            </div>
        ...
        <div class="row">
            ...
            <div class="col-12 col-md-6">
                ...
                <div id="postsContainer">
                    ...
                    <div class="post">
                        <div class="d-flex align-items-center mb-3">
                            <img src="https://i.pinimg.com/736x/0f/e5/34/0fe5347e321b200e639a3b80be44ff8f.jpg" alt="avatar" class="rounded-circle" width="40" height="40">
                            <h5 class="ms-2">Ele me amou</h5>
                        </div>
                        <p>é surreal de lindo essas igrejas antigas né, as vezes me pego pensando nisso</p>
                        <img class="rounded-4" src="https://images.pexels.com/photos/34748544/pexels-photo-34748544.jpeg" width="300px" alt="post01">
                    </div>
                    ...
                    <div class="post">
                        ...
                        <p>ir pra igreja é tão bom, me sinto tão em paz</p>
                    </div>
                    ...
                    <div class="post">
                        <div class="d-flex align-items-center mb-3">
                            ...
                            <h5 class="ms-2">julindo</h5>
                        </div>
                        <p>hoje o culto foi I-N-C-R-I-V-E-L</p>
                    </div>
