    ...
    <header class="container-fluid py-3" style="background-color: #289256;">
        <div class="row align-items-center">
            ...
            <div class="col-6 text-center">
                <h1 style="color: white; text-transform: uppercase;" class="m-0"> Podcast</h1>
            </div>
                ...
                <div id="postsContainer">
                    <div class="post">
                        <div class="d-flex align-items-center mb-3">
                            ...
                            <h5 class="ms-2"> listen </h5>
                        </div>
                        <p> me sinto assim qnd to conversando sobre vários assuntos em uma rodinha </p>
                        <img class="rounded-4" src="https://i.pinimg.com/1200x/1a/d0/22/1ad0227f56d9ce091b70b819ffb85f2a.jpg" width="300px" alt="post01">
                    </div>

                    <div class="post">
                        <div class="d-flex align-items-center mb-3">
                            <img src="https://i.pinimg.com/736x/50/c0/40/50c040b5296ea39079c302ba04e87f68.jpg" alt="avatar" class="rounded-circle" width="40" height="40">
                            <h5 class="ms-2">aqua</h5>
                        </div>
                        <p> tava no metro e vi alguém ouvindo podcast tipo pq vc nao ta ouvindo o último album da taylor swift? </p>
                    </div>

                    <div class="post">
                        <div class="d-flex align-items-center mb-3">
                            <img src="https://i.pinimg.com/736x/a2/cb/71/a2cb71a9960b982ac41578dc1d46518a.jpg" alt="avatar" class="rounded-circle" width="40" height="40">
                            <h5 class="ms-2">minhau</h5>
                        </div>
                        <p> mano eu super ouviria os ALVIN E OS ESQUILOS no podpah, seria tipo um sonho </p>
                        <img class="rounded-4" src="https://i.pinimg.com/736x/33/4c/e7/334ce72c8e5d665632c8b86fc8a34c71.jpg" width="300px" alt="post01">
                    </div>
