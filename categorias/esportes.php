    ...
    <header class="container-fluid py-3" style="background-color: #289256;">
        <div class="row align-items-center">
            ...
            <div class="col-6 text-center">
                <h1 style="color: white; text-transform: uppercase;" class="m-0">Esportes</h1>
            </div>
                ...
                <div id="postsContainer">
                    <div class="post">
                        <div class="d-flex align-items-center mb-3">
                            ...
                            <h5 class="ms-2">julio</h5>
                        </div>
                        <p>CR7 vs messi</p>
                        <img class="rounded-4" src="https://i.pinimg.com/736x/f5/99/a6/f599a6e6c06e0165848d4a16709d63eb.jpg" width="300px" alt="post01">
                    </div>
                    ...
                    <div class="post">
                        <div class="d-flex align-items-center mb-3">
                            ...
                            <h5 class="ms-2">Calleri</h5>
                        </div>
                        <p>VAMOOOOOOOOOO SÃO PAULOOOOOOO</p>
                    </div>
                    ...
                    <div class="post">
                        ...
                        <img class="rounded-4" src="https://i.pinimg.com/736x/38/50/65/3850657ce6b0974067d322188eb2f0dd.jpg" width="300px" alt="post01">
                    </div>
