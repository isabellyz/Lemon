    ...
    <header class="container-fluid py-3" style="background-color: #289256;">
        <div class="row align-items-center">
            ...
            <div class="col-6 text-center">
                <h1 style="color: white; text-transform: uppercase;" class="m-0">Pets e Animais</h1>
            </div>
                ...
                <div id="postsContainer">
                    <div class="post">
                        <div class="d-flex align-items-center mb-3">
                            ...
                            <h5 class="ms-2">analu</h5>
                        </div>
                        <p>olha que fofooo</p>
                        <img class="rounded-4" src="https://i.pinimg.com/736x/cd/6d/9b/cd6d9bd42fb829d183ea244f689eef99.jpg" width="300px" alt="post01">
                    </div>
                    ...
                    <div class="post">
                        <div class="d-flex align-items-center mb-3">
                            ...
                            <h5 class="ms-2">Professora Amanda</h5>
                        </div>
                        <p>queria ter um gato aff</p>
                    </div>
                    ...
                    <div class="post">
                        ...
                        <img class="rounded-4" src="https://i.pinimg.com/1200x/5a/f8/5f/5af85f39b13c8c448602af8f3ca38989.jpg" width="300px" alt="post01">
                    </div>
