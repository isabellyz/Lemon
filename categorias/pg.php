...
<head>
    ...
    <title>Lemon - Filmes e Séries</title>
</head>
            ...
            <div class="col-12 col-md-6">
                ...
                <div class="post-box mb-4">
                    ...
                    <form method="post" action="">
                        <textarea name="conteudo" class="input-post" placeholder="O que está acontecendo na categoria Filmes e Séries?" maxlength="280" required></textarea>
                                ...
                                <div class="d-flex align-items-center mb-3">
                                    ...
                                    <div class="ms-2">
                                        ...
                                        <small class="text-muted">
                                            <?php 
                                            // Formata a data sem usar strtotime() para evitar o warning
