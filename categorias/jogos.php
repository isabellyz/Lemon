    ...
    <header class="container-fluid py-3" style="background-color: #289256;">
        <div class="row align-items-center">
            ...
            <div class="col-6 text-center">
                <h1 style="color: white; text-transform: uppercase;" class="m-0">Jogos</h1>
            </div>
                ...
                <div id="postsContainer">
                    <div class="post">
                        <div class="d-flex align-items-center mb-3">
                            ...
                            <h5 class="ms-2">marcos</h5>
                        </div>
                        <p>Mentira que adiou o gta VI</p>
                        <img class="rounded-4" src="https://i.pinimg.com/736x/a9/9e/d0/a99ed0699ad91cd31c594f77ef26730b.jpg" width="300px" alt="post01">
                    </div>
                    ...
                    <div class="post">
                        <div class="d-flex align-items-center mb-3">
                            ...
                            <h5 class="ms-2">Carlos Alberto vaz</h5>
                        </div>
                        <p>A IA vai mudar os games</p>
                    </div>
                    ...
                    <div class="post">
                        ...
                        <img class="rounded-4" src="https://i.pinimg.com/736x/97/8c/7f/978c7f0c7b02f58e9507623afc50f739.jpg" width="300px" alt="post01">
                    </div>
