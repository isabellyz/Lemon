    ...
    <header class="container-fluid py-3" style="background-color: #289256;">
        <div class="row align-items-center">
            ...
            <div class="col-6 text-center">
                <h1 style="color: white; text-transform: uppercase;" class="m-0">Cultura Mundial</h1>
            </div>
                ...
                <div id="postsContainer">
                    <div class="post">
                        <div class="d-flex align-items-center mb-3">
                            ...
                            <h5 class="ms-2">pedro</h5>
                        </div>
                        <p>Meu sonho é encontrar o mandela</p>
                    </div>
                    ...
                    <div class="post">
                        <div class="d-flex align-items-center mb-3">
                            ...
                            <h5 class="ms-2">larissa_andrade</h5>
                        </div>
                        <p>Queria ir pra paris</p>
                    </div>
                    ...
                    <div class="post">
                        ...
                        <p>Facistas não passaram!!</p>
                        <img class="rounded-4" src="https://i.pinimg.com/1200x/55/4d/12/554d1284e251ab255b43821a648b17b6.jpg" width="300px" alt="post01">
                    </div>
