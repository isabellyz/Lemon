    ...
    <header class="container-fluid py-3" style="background-color: #289256;">
        <div class="row align-items-center">
            ...
            <div class="col-6 text-center">
                <h1 style="color: white; text-transform: uppercase;" class="m-0">Comida e bebida</h1>
            </div>
            ...
            <div class="col-12 col-md-6">
                ...
                <div id="postsContainer">
                    <div class="post">
                        ...
                        <p>Adoro Churrasco slc skrrrrrrrrrr</p>
                        <img class="rounded-4" src="https://images.pexels.com/photos/1482803/pexels-photo-1482803.jpeg" width="300px" alt="post01">
                    </div>
                    ...
                    <div class="post">
                        ...
                        <p>Uma linguiça agora cairia bem!!!</p>
                    </div>
                    ...
                    <div class="post">
                        ...
                        <p>vou ir com os mlk beber e jogar conversa fora</p>
                        <img class="rounded-4" src="https://images.pexels.com/photos/5531894/pexels-photo-5531894.jpeg" width="300px" alt="post01">
                    </div>
