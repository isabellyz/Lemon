    ...
    <header class="container-fluid py-3" style="background-color: #289256;">
        <div class="row align-items-center">
            ...
            <div class="col-6 text-center">
                <h1 style="color: white; text-transform: uppercase;" class="m-0"> Programação </h1>
            </div>
    ...
    <div class="container mt-5">
        <div class="row">
            ...
            <div class="col-12 col-md-6">
                ...
                <div class="post">
                    <div class="d-flex align-items-center mb-3">
                        <img src="https://i.pinimg.com/736x/0b/6c/44/0b6c44a2bb3e369362c57911c66fbcc9.jpg" alt="avatar" class="rounded-circle" width="40" height="40">
                        <h5 class="ms-2"> desempregadito </h5>
                    </div>
                    <p> queria aquele emprego gringo ganhando em dólar suave fazendo altos programas minha vida já tava pronta já </p>
                    <img class="rounded-4" src="https://i.pinimg.com/1200x/e8/bc/a5/e8bca5a80e6e6494a556fb8a22c864d3.jpg" width="300px" alt="post01">
                    </div>

                    <div class="post">
                        <div class="d-flex align-items-center mb-3">
                            <img src="https://i.pinimg.com/1200x/4f/5d/4f/4f5d4f902714b17c373880914b16eca0.jpg" alt="avatar" class="rounded-circle" width="40" height="40">
                            <h5 class="ms-2"> namorado da joana </h5>
                        </div>
                        <p> se liguem no que eu fiz pra minha namorada</p>
                        <img class="rounded-4" src="https://i.pinimg.com/1200x/2a/4c/ae/2a4caebf2f2b67f9cb9962ba7574b925.jpg" width="300px" alt="post01">
                    </div>

                    <div class="post">
                        <div class="d-flex align-items-center mb-3">
                            <img src="https://i.pinimg.com/736x/3a/5e/bc/3a5ebce992678e5020998b5a5b44290c.jpg" alt="avatar" class="rounded-circle" width="40" height="40">
                            <h5 class="ms-2"> fatecano </h5>
                        </div>
                        <p>as pessoas nao entendem qnd eu falo programa tipo eu nem sei ligar o pc se liguem #programacao</p>
                    </div>
